...
def test_standard_thousand():
	assert money_conversion("$900.9 thousand") == 900900 #failed

def test_range():
	assert money_conversion("$3.5-4 million") == 3500000 #failed
...
def test_list():
	assert money_conversion(['$410.6 million (gross)', '$378.5 million (net)']) == 410600000 #failed
